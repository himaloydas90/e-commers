    ...
    <section>
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 px-2 md:px-20">
          {order.map((item) => (
            <div key={item.title} className="flex pb-12 items-center gap-4">
              ...
              <div>
                <h5 className="font-medium text-[20px] text-primary">
                  {item.title}
                </h5>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-10 pb-14 pt-14 border-t-2 border-t-[#E5E5E5] border-b-2 border-b-[#E5E5E5]">
          ...
          {/* Quick Links */}
          <div>
            <h5 className="font-medium text-[20px] pb-6 text-primary">
              QUICK LINKS
            </h5>
            <ul>
              <li className="pb-6">
                <Link to="/" className="text-base font-normal text-secondary">
                  About us
                </Link>
              </li>
              <li className="pb-6">
          ...
          {/* Contact Section */}
          <div>
            <Link className="font-medium text-[20px] pb-6 text-primary">
              CONTACT
            </Link>
            <p className="pb-6">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            ...
            <div className="flex pb-12 items-center gap-4">
              <div className="text-brand text-5xl">
                <FaHeadphonesAlt />
              </div>
              <div>
                <h5 className="font-medium text-[20px] text-primary">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center py-5 justify-between gap-4">
        ...
        <div className="md:flex gap-2 items-center">
          <p className="text-brand text-xl whitespace-nowrap text-center">
            Pay with
          </p>
